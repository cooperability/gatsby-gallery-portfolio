...
Decap CMS can run in any frontend web environment, but the quickest way to try it out is by running it on a pre-configured starter site with Netlify. The example here is adapted from [One Click Hugo CMS](https://github.com/decaporg/one-click-hugo-cms). Use the button below to build and deploy your own copy of the repository:
